...
DATASET_PATH="/workspace/data/datasets/oscar-en-10k/oscar-en-10k-meg-llama_text_document"
PRETRAIN_CHECKPOINT_PATH="/workspace/data/models/llm/Qwen/Qwen2.5-7B-Instruct-tp1-pp2"
TRAIN_TOKENS=100000000
WARMUP_TOKENS=1000
OUTPUT_BASEPATH="/workspace/output/qwen2.5/7B_4k"
...
NAME="pretrain-mcore-qwen2.5-${MODEL_SIZE}-lr-${LR}-minlr-${MIN_LR}-bs-${BATCH_SIZE}-gbs-${GLOBAL_BATCH_SIZE}-seqlen-${SEQ_LEN}-pr-${PR}-tp-${TP}-pp-${PP}-ac-${AC}-do-${DO}-sp-${SP}-tt-${TRAIN_TOKENS}-wt-${WARMUP_TOKENS}"
