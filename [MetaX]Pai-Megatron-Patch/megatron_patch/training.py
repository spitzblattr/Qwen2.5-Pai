...
from megatron.training.training import (
                            build_train_valid_test_data_iterators, get_optimizer_param_scheduler,
                            setup_model_and_optimizer, print_datetime)
...
try:
    ...
    from megatron.training.model import DistributedDataParallel as DDP
