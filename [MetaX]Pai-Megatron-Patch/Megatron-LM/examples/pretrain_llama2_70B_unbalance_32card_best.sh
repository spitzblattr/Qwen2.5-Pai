...
export MCCL_IB_GID_INDEX=1
export MAX_JOBS=20

export MCBLAS_CUSTOMIZED_CONFIG_PATH=/workspace/Megatron-LM/examples/mcblas_customized_config_llama2_70B.yaml
...
NETWORK_SIZE_ARGS=" \
       ...
       --recompute-num-layers-list 1 1 0 0 0 0 0 0 \
       "
