...
#export MCBLAS_CUSTOMIZED_CONFIG_PATH=/data/nfs/lyt/mcblas_benchmark/llama2_13b/mcblas_customized_config_tp2.yaml
#export MCBLAS_CUSTOMIZED_CONFIG_PATH=/data/nfs/lyt/mcblas_benchmark/llama2_13b/mcblas_customized_config.yaml
...
DATA_PATH=/external/datasets/dataset-7/oscar-en-10k/oscar-en-10k-meg-llama_text_document
...
TOKENIZER_PATH=/external/models/llm/Llama/llama-2-13b/tokenizer.model
...
# --recompute-num-layers-list 2 3 3 2 \
RECOMPUTE_ARGS="
       --pipline-num-layers-list 9 10 11 10 \
