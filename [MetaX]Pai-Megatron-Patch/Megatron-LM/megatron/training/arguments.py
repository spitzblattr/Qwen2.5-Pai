...
def _add_training_args(parser):
    ...
    group.add_argument('--no-repeat-kv', action='store_true',
                       help='Whether repeat key and value when calculating group '
                       'query attention in DotProductAttention. Recommended when '
                       'NOT MHA_USE_BLAS.')
...
def _add_data_args(parser):
    ...
    group.add_argument('--accumulate-bf16', type=int, default=0,
            help='Number of parallel threads per rank for dataset builder')
