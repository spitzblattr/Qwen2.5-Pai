...
python /workspace/Pai-Megatron-Patch/toolkits/sft_data_preprocessing/build_idxmap_sft_dataset.py \
    --input /mnt/public/data/spitzblattr/all_train_data_0930_153478.jsonl \
    --patch-tokenizer-type Qwen2Tokenizer \
    --seq-length 2048 \
    --output-prefix /mnt/public/data/spitzblattr/max_len_2048/max_len_2048 \
